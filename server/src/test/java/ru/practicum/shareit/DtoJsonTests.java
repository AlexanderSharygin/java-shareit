...
public class DtoJsonTests {
    ...
    void testItemDtoFullJson() throws Exception {
        ...
        ItemDto itemDto = new ItemDto(1L, "Test", "Description", true, user,
                25L, List.of(comment1, comment2), lastBooking, nextBooking);
    ...
    void testBookingDtoFullJson() throws Exception {
        ...
        assertThat(result).extractingJsonPathNumberValue("$.item.request.id").isEqualTo(23);
        assertThat(result).extractingJsonPathStringValue("$.item.request.description").isEqualTo("Ir");
    }
