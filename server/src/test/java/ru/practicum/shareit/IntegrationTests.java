...
public class IntegrationTests {
    ...
    void getItemByIdTest() {
        ...
        User user = query
                ...
                .getSingleResult();
        long id = user.getId();
        ItemDto itemDto = new ItemDto(1L, "name", "desc", true, user, null, new ArrayList<>(), null, null);
    ...
    void getAllItemsTest() {
        ...
        ItemDto itemDto = new ItemDto(1L, "name", "desc", true, user, null, new ArrayList<>(),
                null, null);
        itemService.create(id, itemDto);
    ...
    void getAllForUserItemsTest() {
        ...
        ItemDto itemDto = new ItemDto(1L, "name", "desc", true, user, null, new ArrayList<>(), null, null);
        itemService.create(id, itemDto);
        ItemDto itemDto2 = new ItemDto(2L, "name2", "desc2", true, user2, null, new ArrayList<>(),
                null, null);
        itemService.create(id, itemDto2);
        Pageable paging = PageRequest.of(1, 1);
        List<ItemDto> items = itemService.getAllByUserId(id, paging);
    ...
    void getItemsByNameTest() {
        ...
        itemService.create(id, itemDto2);
        Pageable paging = PageRequest.of(1, 1);
        List<ItemDto> items = itemService.getAllByNameOrDescription("name", paging);
    ...
    void createItemTest() {
        ...
        ItemDto itemDto = new ItemDto(1L, name, "desc", true, user, null, new ArrayList<>(), null,
                null);
        itemService.create(id, itemDto);
    ...
    void createBookingTest() {
        ...
        String name = RandomStringUtils.randomAlphabetic(10);
        ItemDto itemDto = new ItemDto(1L, name, "desc", true, user2, null, new ArrayList<>(), null,
                null);
