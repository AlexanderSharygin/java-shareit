...
public class UserServiceTests {
    ...
    public void createEmptyEmailTest() {
        ...
        assertEquals("Поле Email обязательное и не может быть пустым", exception.getParameter());
    }
    ...
    public void createEmptyNameTest() {
        ...
        assertEquals("Поле Name обязательное и не может быть пустым", exception.getParameter());
    }
