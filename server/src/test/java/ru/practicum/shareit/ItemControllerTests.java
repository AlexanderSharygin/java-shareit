...
public class ItemControllerTests {
    ...
    void getByNameSuccessTest() throws Exception {
        ...
        when(itemService.getAllByNameOrDescription("name", paging))
    ...
    void createExceptionTest() throws Exception {
        ...
        mvc.perform(post("/items")
                ...
                .andExpect(jsonPath("$.description", is("Invalid parameter - Available flag can't be null")));
    }
    ...
    void addCommentExceptionTest() throws Exception {
        ...
        mvc.perform(post("/items/1/comment")
                ...
                .andExpect(jsonPath("$.description", is(
                        "Invalid parameter - User with id 1 can't left the comment for booking with id 1")));
    }
}