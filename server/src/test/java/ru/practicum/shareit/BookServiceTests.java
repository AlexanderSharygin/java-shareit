...
public class BookServiceTests {
    ...
    public void createBookingForUnavailableItemTest() {
        ...
        assertEquals("Нельзя создать бронирование для недоступной вещи",
    ...
    public void createBookingWhenUserIdEqualsItemOwnerIdTest() {
        ...
        assertEquals("Невозможно создать бронирование для собственной вещи", exception.getMessage());
    }
    ...
    public void getBookingByIdUserIdIsNotBookerOrOwnerIdExceptionTest() {
        ...
        assertEquals("User c id 5не является собственником или создателем бронирования 1", exception.getMessage());
    }
    ...
    public void changingBookingStatusForAlreadyApprovedBookingExceptionTest() {
        ...
        assertEquals("Ошибка обновления статуса для бронирования с id 1", exception.getParameter());
    }
    ...
    public void getBookingForUserWrongStatusException() {
        ...
        assertEquals("Статус Wrong не известен", exception.getParameter());
    }
